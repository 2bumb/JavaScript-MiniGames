...
function submitGuess() {
    ...
    console.log(answer);
    if (isNaN(guess) || guess < 1 || guess > 10) { //if "if (isNaN(guess)"we are checking if soemthing is not a number ex:hello is a string so it will be true || is means or.  guess < 1 || guess > 100) mean the guess must be less than 1 or greater than 100
